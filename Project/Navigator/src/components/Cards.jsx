...
export default function Cards({ id, img, title, price, rate, reviews, time }) {
    ...
    return (
            <div className='border-1 mx-30 my-5'>
                    ...
                    <div className='p-[16px] flex flex-col gap-[8px]'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <button onClick={() => addToCart(id)} className='city cursor-pointer flex justify-center items-center p-1 rounded-sm'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="#0e4d65" fill-rule="evenodd" d="M9.5 19.5a1 1 0 1 0 0-2a1 1 0 0 0 0 2m0 1a2 2 0 1 0 0-4a2 2 0 0 0 0 4m7-1a1 1 0 1 0 0-2a1 1 0 0 0 0 2m0 1a2 2 0 1 0 0-4a2 2 0 0 0 0 4M3 4a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .476.348L9.37 14.5H17a.5.5 0 0 1 0 1H9.004a.5.5 0 0 1-.476-.348L5.135 4.5H3.5A.5.5 0 0 1 3 4" clip-rule="evenodd" /><path fill="#0e4d65" d="M8.5 13L6 6h13.337a.5.5 0 0 1 .48.637l-1.713 6a.5.5 0 0 1-.481.363z" /></svg>
                            </button>
                        </div>
                    </div>
                </div>
