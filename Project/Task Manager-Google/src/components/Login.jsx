      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-8 py-10 space-y-6">
          <div>
            ...
            <input type="text" name="email" onChange={handlechange} placeholder="Enter Your Email" className="w-full border rounded-xl px-4 py-3 bg-gray-50 outline-none focus:ring-2 focus:ring-purple-400" />
          </div>
          <div>
          ...
          {/* Login Button */}
          <button onClick={handleLogin} className="w-full py-3 cursor-pointer rounded-xl text-white font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:opacity-90 transition" >
            Login
          </button>
