    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-white to-blue-100 p-6">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-pink-100">
          ...
          <button onClick={handleTask} className="mt-4 w-full py-3 rounded-lg font-semibold text-white bg-gradient-to-r from-blue-400 to-pink-400 hover:scale-[1.02] duration-200 shadow-lg cursor-pointer">{editIndex ? "Update Task" : "Add Task"}</button>
        </div>
